...
char* indexes(const char* path)
{
    char* temp1 = (char* )malloc(1000 * sizeof(char));
    strcpy(temp1,path);
...
const char* lookup(const char* path)
{
    ...
    char* temp8 = "png";
    temp = strstr(path,".");
    if((strcasecmp((temp + 1), temp1)) == 0)
    {
        const char* MIME = "text/css";
        return MIME;
    }
    if((strcasecmp((temp + 1), temp2)) == 0)
    {
        const char* MIME = "text/html";
        return MIME;
    }
    if((strcasecmp((temp + 1), temp3)) == 0)
    {
        const char* MIME = "image/gif";
        return MIME;
    }
    if((strcasecmp((temp + 1), temp4)) == 0)
    {
        const char* MIME = "image/x-icon";
        return MIME;
    }
    if((strcasecmp((temp + 1), temp5)) == 0)
    {
        const char* MIME = "image/jpeg";
        return MIME;
    }
    if((strcasecmp((temp + 1), temp6)) == 0)
    {
        const char* MIME = "text/javascript";
        return MIME;
    }
    if((strcasecmp((temp + 1), temp7)) == 0)
    {
        const char* MIME = "text/x-php";
        return MIME;
    }
    if((strcasecmp((temp + 1), temp8)) == 0)
    {
